...
export default function ProjectCard({
  ...
  return (
    <div 
      ...
      className="group relative bg-white rounded-xl border-2 border-gray-200 hover:border-blue-400 p-6 shadow-sm hover:shadow-lg transition-all duration-300 flex flex-col cursor-pointer">
      {/* Card Header */}
      <div className="mb-4">
      ...
      <div className="mb-4 flex flex-wrap gap-2 flex-grow">
        {project.project_info?.technologies_used?.slice(0, 2).map((tech) => (
          <button
            ...
            onClick={(e) => handleButtonClick(e, () => handleTagClick(tech))}
        ...
        {project.project_info?.algorithms_models?.slice(0, 1).map((algo) => (
          <button
            ...
            onClick={(e) => handleButtonClick(e, () => handleTagClick(algo))}
              ...
              <div className="flex flex-wrap gap-1.5">
                {project.project_info.datasets_used.map((dataset) => (
                  <button
                    ...
                    onClick={(e) => handleButtonClick(e, () => handleTagClick(dataset))}
                    className={`text-xs px-2 py-0.5 rounded transition ${
              ...
              <div className="flex flex-wrap gap-1.5">
                {project.project_info.keywords.slice(0, 4).map((keyword) => (
                  <button
                    ...
                    onClick={(e) => handleButtonClick(e, () => handleTagClick(keyword))}
